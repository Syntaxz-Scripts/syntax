...
-- Create the button inside the Forsaken tab
local autoAimBtn = styledBtn(tf, 186, contenty, "Auto Aim: OFF", Color3.fromRGB(120, 60, 120))
contenty += autoAimBtn.Size.Y.Offset + 6

-- Toggle logic
autoAimBtn.MouseButton1Click:Connect(function()
    autoAimEnabled = not autoAimEnabled
    autoAimBtn.Text = "Auto Aim: " .. (autoAimEnabled and "ON" or "OFF")
    notify("Auto Aim " .. (autoAimEnabled and "enabled" or "disabled"))
end)

-- Heartbeat connection that runs your logic only when enabled
